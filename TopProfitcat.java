...
public class TopProfitCat 
{
	public static class MyMapper1 extends Mapper<LongWritable,Text,Text,Text>
	{
		public void map(LongWritable key,Text values,Context context) throws IOException,InterruptedException
		{
			...
			long profit=sales-costs;
			String ageProfit=str[2]+","+profit;
			if(profit>0)
			{
			context.write(new Text(str[4]), new Text(ageProfit));
			}
		}
	}
	...
	public static class MyReducer1 extends Reducer<Text,Text,Text,Text>
	{
		public void reduce(Text key,Iterable<Text> values,Context context) throws IOException,InterruptedException
		{
			...
			for(Text val:values)
			{
				...
				age=str[0];
				long profit=Long.parseLong(str[1]);
				sum=sum+profit;
				ageTot=key+"\t"+age;
			}
	...
	public static void main(String[] args) throws Exception
	{
		...
		job1.setJarByClass(TopProfitCat.class);
       ...
       // job1.setMapOutputValueClass(Text.class);
		...
		job2.setJarByClass(TopProfitCat.class);
